    ...
    case 'big':
      return (
        <button
          ...
          disabled={disabled}
          className={cn(
            'flex w-full items-center justify-center rounded-full bg-accent py-4 px-5 text-sm font-light text-light transition-colors duration-300 hover:bg-accent-hover focus:bg-accent-hover focus:outline-none lg:text-base',
            {
