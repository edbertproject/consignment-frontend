...
const AddressCard: React.FC<AddressProps> = ({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-sub-heading">{address.receiver_name}</p>
      <p className="text-sm text-sub-heading">{address.phone_number}</p>
      <p className="text-sm text-sub-heading">{address.full_address}</p>
